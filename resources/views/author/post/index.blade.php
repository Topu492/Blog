...
<div class="container-fluid">
            <div class="block-header">
                <h2>
                    <a class="btn btn-info waves-effect" href="{{ route('author.post.create') }}"> <i class="material-icons">add</i> <span>Add New Post</span></a>
                </h2>
            </div>
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                    		...
                                    		<th class="text-center">
                                    			...
                                    			<form action="{{ route('author.post.destroy',$post->id) }}" method="post"  style="display:none;"  id="delete-form-{{$post->id }}">
