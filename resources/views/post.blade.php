...
@push('css')
<link href="{{asset('public/assets/frontend/css/single-post/css/styles.css') }}" rel="stylesheet">

<link href="{{asset('public/assets/frontend/css/single-post/css/responsive.css') }}" rel="stylesheet">
<style>
     .favorite_post{
        color: blue;
        ...
        .header_bg{
            height: 400px;
            width: 1400px;
            background: url({{asset('public/storage/post/'.$post->image) }});
                             ...
                             <div class="col-lg-4 col-md-6">
                                <div class="card h-100">
                                    <div class="single-post post-style-1">
                                        ...
                                        })"></i>{{ $randompost->favorite_users->count() }}</a>

                                         @else
                                 <a  class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randompost->id)->count()==0 ? 'favorite_post' : '' }}" href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randompost->id  }}').submit();" ><i class="ion-heart"></i>{{ $randompost->favorite_users->count() }}
                                      </a>

                                     <form action="{{ route('favorite.add',$randompost->id) }}" method="post" style="display: none;" id="favorite-form-{{ $randompost->id }}">
                                            @csrf
                                        </form>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                        <p>For a new post comment,you need to login first</p>
                        <a href="{{ route('login') }}"><span class="badge badge-info">Login</span></a>
                    ...
                    <div class="commnets-area ">
                        ...
                        <div class="comment">
                            ...
                            <p>No comment yet,Be comment first</p>
