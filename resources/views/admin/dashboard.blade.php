...
<div class="container-fluid">
    ...
    <div class="row clearfix">
     ...
     <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
            ...
            <div class="info-box bg-purple hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{ $total_author }}" data-speed="15" data-fresh-interval="20"></div>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
            <div class="card">
                <div class="header">
                    <h2 class="text-center" style="color:purple;">MOST POPULAR POST</h2>
                </div>
                <div class="body">
                        ...
                        <table class="table table-hover dashboard-task-infos">
                            ...
                            <tbody>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <a class="btn btn-primary" target="_blank" href="{{ route('post.details',$post->slug) }}">View</a>
                                   </td>
                               </tr>
    ...
    <div class="row clearfix">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    <h2 class="text-center" style="color:blue;">TOP 10 ACTIVE AUTHOR</h2>
