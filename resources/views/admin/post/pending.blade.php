...
<div class="container-fluid">
            <div class="block-header">
                <h2>
                    <a class="btn btn-info waves-effect" href="{{ route('admin.post.create') }}"> <i class="material-icons">add</i> <span>Add New Post</span></a>
                </h2>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                    		...
                                    		<th>{{ $post->created_at->toDateString() }}</th>
                                ...
                                <form action="{{ route('admin.post.approve',$post->id) }}" id="approve-form" method="POST" style="display: none;">
                                    @csrf
                                </form>
                                ...
                                @endif
                                    			...
                                    			<form action="{{ route('admin.post.destroy',$post->id) }}" method="post"  style="display:none;"  id="delete-form-{{$post->id }}">
